...
#
#     PHX_SERVER=true bin/bccm_dashboard start
#
...
if config_env() == :prod do
  ...
  config :bccm_dashboard, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :bccm_dashboard, BccmDashboard.Mailer,
